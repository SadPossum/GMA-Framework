...
public static class DesignTimeDbContextOptionsFactory
{
    private const string DefaultPostgreSqlConnection =
        "Host=localhost;Port=5432;Database=gma_design;Username=postgres;Password=postgres";

    private const string DefaultSqlServerConnection =
        "Server=localhost,1433;Database=GmaDesign;User Id=sa;Password=Pass@word1;TrustServerCertificate=True";
