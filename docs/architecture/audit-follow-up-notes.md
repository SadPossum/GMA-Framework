...
- Reorganized `GMA-Skeleton.sln` so Administration, Catalog, and ServiceDefaults test projects sit under matching `tests/*` solution folders, and added an architecture guard for future test-project nesting.
