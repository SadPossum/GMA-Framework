...
- [Task Terminal Failure And Attempt Context Task](architecture/task-terminal-failure-and-attempt-context-task.md)
...
- [Atomic Distributed Rate Limiting](architecture/atomic-distributed-rate-limiting.md)
- [Method-Aware HTTP Rate Limiting Task](architecture/method-aware-http-rate-limiting-task.md)
